...
function VegSel() {
  ...
  const handleVegPizza = () => {
    navigate(`/EnglishPizzaVeg`);
  };

  const handleNVegPizza = () => {
    navigate(`/EnglishPizzaNonVeg`);
